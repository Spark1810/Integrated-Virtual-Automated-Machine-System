...
try:
    mycursor.execute("CREATE DATABASE assis2")
    mycursor.execute("USE assis2")
...
try:
    command="CREATE TABLE user(Id varchar(50) PRIMARY KEY,Name char(30))"
...
def doha():
    ...
    if dah==0:
        print("Dohe        : मैं जानूँ मन मरि गया, मरि के हुआ भूत | , मूये पीछे उठि लगा, ऐसा मेरा पूत ||")
        tvoice2("मैं जानूँ मन मरि गया, मरि के हुआ भूत | , मूये पीछे उठि लगा, ऐसा मेरा पूत ")
        print("Translation : main jaanoon man mari gaya, mari ke hua bhoot | , mooye peechhe uthi laga, aisa mera poot")
        print("Meaning     : By mistake I had known that my mind was full, but he became a ghost after death. Even after death it got up and followed me, this is how my mind is like a child.")  
    elif dah==1:
        print("Dohe        : भक्त मरे क्या रोइये, जो अपने घर जाय | रोइये साकट बपुरे, हाटों हाट बिकाय ||")
        tvoice2("भक्त मरे क्या रोइये, जो अपने घर जाय | रोइये साकट बपुरे, हाटों हाट बिकाय")
        print("Translation : bhakt mare kya roiye, jo apane ghar jaay | roiye saakat bapure, haaton haat bikaay")
        print("Meaning     : Why do saints who have attained their imperishable home in the form of welfare, leave the body of such a devotee? ")
    elif dah==2:
        print("Dohe        : मैं मेरा घर जालिया, लिया पलीता हाथ |जो घर जारो आपना, चलो हमारे साथ ||")
        tvoice2("मैं मेरा घर जालिया, लिया पलीता हाथ |जो घर जारो आपना, चलो हमारे साथ ")
        print("Translation : main mera ghar jaaliya, liya paleeta haath |jo ghar jaaro aapana, chalo hamaare saath ")
        print("Meaning     : The world - in the body I - the ego of mineness - affection is happening - take the fire of knowledge in hand and burn this house. Your ego - sets the house on fire.")
    elif dah==3:
        print("Dohe        : मैं मेरा घर जालिया, लिया पलीता हाथ |जो घर जारो आपना, चलो हमारे साथ ||")
        tvoice2("मैं मेरा घर जालिया, लिया पलीता हाथ |जो घर जारो आपना, चलो हमारे साथ")
        print("Translation : shabd vichaaree jo chale, gurumukh hoy nihaal | kaam krodh vyaapai nahin, kaboon na graasai kaal ")
        print("Meaning     : The one who behaves by thinking of the words of Gurmukh, becomes fruitful. He is not tormented by lust and anger and he never falls in the mouth of imagination.")
    elif dah==4:
        print("Dohe        : शब्द विचारी जो चले, गुरुमुख होय निहाल | काम क्रोध व्यापै नहीं, कबूँ न ग्रासै काल ||")
        tvoice2("शब्द विचारी जो चले, गुरुमुख होय निहाल | काम क्रोध व्यापै नहीं, कबूँ न ग्रासै काल ")
        print("Translation : jab lag aash shareer kee, miratak hua na jaay | kaaya maaya man tajai, chaude raha bajaay")
        print("Meaning     : As long as there is hope and attachment to the body, one cannot destroy the mind. That's why after removing the attachment of the body and the lust of the mind, one should sit in the field of satsang.")
    else:
        print("Dohe        : जब लग आश शरीर की, मिरतक हुआ न जाय | काया माया मन तजै, चौड़े रहा बजाय ||")
...
def calcicauliflower():
    # initialize the recognizer
    r = sr.Recognizer()
    # define the function to process spoken input
    def process_voice_input():
        with sr.Microphone() as source:
            print("Speak your equation...")
            audio = r.listen(source)
        ...
        try:
            ...
            print("I could not understand you"+z)
            return None
        except sr.RequestError as e:
            print("Sorry for the inconvenice. Unable to process your request.")
            return None
        # clean up input text
        ...
        try:
            ...
            print("Invalid input")
    # call the function to process spoken input
    process_voice_input()
...
def Take_query():
    ...
    # this will exit and terminate the program
        ...
        elif "webpage" in query:
            try:
                import htmlusingpython.py
            except:
                """no worries"""
